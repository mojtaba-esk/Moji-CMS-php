...
*/
	...
	//<!-- Insert new rows
		...
		if( $_GET['mod'] == 'new' && isset( $_POST['submit']))
		{
			...
			msgDie( Lang::getVal( 'inserted'), './?md='. Module::$name .'&sub='. $_GET['sub'] .'&itemId='. intval( $_GET['itemId']), 1);
			return;
	...
	$tpl -> assign_vars( array(
		...
		'RETURN_URL'	=> '?md='. Module::$name .'&sub='. $_GET['sub'] .'&itemId='. intval( $_GET['itemId']),
	...
	//<!-- Prepare Form Elements...
		...
		$form[] = $inpt -> textArea( 'content', 0, array( 'class' => 'ltr', 'cols' => '120', 'rows' => '45', 'focus' => 1));
