...
*/
	...
	$srchSQL .= ' AND `productId` = '. $_cfg['product']['id'];
	...
	//<!-- Categories...
		...
		if( Module::$opt['categoryMod'] && is_array( $cats = getCats( Module::$name, Lang::viewId(), 'cats', ' AND `productId` = '. $_cfg['product']['id'])))
		{
	...
	$tpl -> assign_vars( array(
		...
		'PAGE_TITLE' => $_cfg['product']['title'] .' | '. Lang::getVal( Module::$name) . $archvTitle,
