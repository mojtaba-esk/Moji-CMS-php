...
*/
	...
	//<!-- Prepare Form Elements...
		...
		$form[] = $inpt -> text( 'email', 0, array( 'dir' => 'ltr', 'align' => 'left', 'size' => 40, 'validate' => 'required email'));
		...
		//<!-- Prepare the Languages Tabs ...
			...
			{
				$form[] = $tab -> opn( $lng);
				$form[] = $inpt -> text( 'title', $lng[ 'id'], array( 'dir' => $lng['dir'], 'align' => $lng['align'], 'size' => 40 /* , 'validate' => 'required'*/));
