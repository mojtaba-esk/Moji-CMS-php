...
*/
	...
	//<!-- Delete The Files
		...
		if( $isDeleted && ( Module::$opt['imageFile'] || Module::$opt['attchmnt']))
		{
			lib( array( 'File', 'Img'));
		...
		}// End of if( $isDeleted && ( Module::$opt['imageFile'] || Module::$opt['attchmnt']));
