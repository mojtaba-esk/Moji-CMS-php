			...
			while( $cols = $inpt -> getRow())
			{
				...
				if( !$rltdId)
				{
					...
					//<!-- Upload The image ...
						...
						$files = $inpt -> getFiles();
						empty( $files) or $file -> save( $rltdId, $files[ 'image'][ 'tmp_name'], 'img.'. $_GET['sub'] .'.');
	 ...
	 */		
		...
		//<!-- Prepare the Languages Tabs ...
			...
			foreach( $lngs as $lng)
			{
				...
				$form[] = $inpt -> textArea( 'body', $lng[ 'id'], array( 'class' => & $lng['dir'], 'cols' => '60', 'rows' => '3'));
