...
*/
	...
	//<!-- Search 
		...
		//$srchSQL .= ' AND `rltdId` != '. $getPrms['rltdId'];
	...
	$tpl -> assign_vars( array(
		...
		'PARENT_EID'		=> & $_GET['ids']['ownerId'][0],
		'PARENT_EID_TITLE'	=> & $_GET['prntElmId'],
		'PARENT_EID_TITLE2'	=> & $_GET['ids']['ownerName'][0],
	...
	if( is_array( $rws))
	{
		foreach( $rws as $key => $rw)
		{
			$tpl -> assign_block_vars( 'myblck',  array(
				...
				'CLASS'		=> $rw['id'] == $getPrms['ownerId'] ? 'popMarkd' : '',
