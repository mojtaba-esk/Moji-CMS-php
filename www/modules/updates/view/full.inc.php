...
*/
	...
	//<!-- Send vars to Template . . .
		...
		$tpl -> assign_vars( array(
			...
			'PAGE_TITLE'	=> $_cfg['product']['title'] .' | '. Lang::getVal( Module::$name) .' | '. $rw['title'],
			'PAGE_KEYWORDS'	=> $_cfg['product']['title'] .','.	Lang::getVal( Module::$name) .','.	$rw['title'],
			'PAGE_DESC'		=> $_cfg['product']['title'] .' - '. Lang::getVal( Module::$name) .' - '. briefStr( isset( $rw['lead']) ? $rw['lead'] : strip_tags( $rw['body']), 80),
