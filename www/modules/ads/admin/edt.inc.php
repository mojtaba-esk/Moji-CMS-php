...
*/
	 ...
	 */		
		...
		/*	$posRows=DB::load(
			...
			printr("gholiu");
			/**/
			$form[] = $inpt -> dropDown( 'posInfoId', 0, array( 
																		'items'	=> 1, 
																		'dir'	=> Lang::$info['dir'],
		...
		$form[] = $inpt -> date( 'endPblishTime', 0 /*Language Id*/, array( 
															'elmnts' => 'd,M,Y,G,i',
															//'type' => 'jalali',
															//'value' => 'now',
															'defVal'	=> null,//$_GET['mod'] == 'new' ? 'now' : NULL,
															'difY'		=> array( -10, 1),
															'attribs' => array( 
																'dir' => Lang::$info['dir'],
																'align' => Lang::$info['align']
		...
		/*Module::$opt['typeMod'] and $form[] = $inpt -> dropDown( 'type', 0, array( 
																		'items'	=> arrStLang( $tmp = enumItems( Module::$name.'_main', 'type')), 
																		'dir'	=> Lang::$info['dir'],
																		'align'	=> Lang::$info['align']
																		
																)
														);	/*type be jaye digar montaghel shod*/
		$form[] = $inpt -> text( 'url', 0, array( 'dir' => $lng['dir'], 'align' => $lng['align'], 'size' => 80));														
						
//printr(Module::$name.'_main');
