...
*/
	...
	$tpl -> assign_vars( array(
		...
		'RETURN_URL'	=> '?md='. Module::$name .'&sub='. $_GET['sub'] .'&typeId='. $_GET['typeId'],
	 ...
	 */		
		...
		$form[] = $inpt -> hidden( 'typeId', 0, $_GET['typeId']);
		
		$form[] = $inpt -> dropDown( 'fldType', 0, array(
													'items'	=> arrStLang( $tmp = enumItems( Module::$name .'_'. $_GET['sub'], 'fldType')), 
													'class'	=> & Lang::$info['dir'],
											)
									);
